...
(function() {
  if (new Date() > new Date("2013/10/22")) {
    console.warn('By this date the fix from this file should become' +
      ' available in Polymer proper. Check into that, remove this file and' +
      ' switch to polymer/boot.js across the project.');
    return;
  }
  if (new Date() > new Date("2013/11/1")) {
    console.warn('By this date Polymer proper should supposedly get rid' +
      ' of boot.js altogether. Check into that and remove this file and' +
      ' references to it AND to polymer/boot.js across the project.');
    return;
  }
